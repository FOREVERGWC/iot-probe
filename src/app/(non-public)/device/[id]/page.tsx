								...
								<Row label="数字控制">
									<div className="flex gap-x-24">
										<div className="flex items-center gap-x-0.5">
											<label>IO1</label>
											<Checkbox checked={checkboxState.io1} onCheckedChange={() => handleCheckboxChange('io1')} />
										</div>
										<div className="flex items-center gap-x-0.5">
											<label>IO2</label>
											<Checkbox checked={checkboxState.io2} onCheckedChange={() => handleCheckboxChange('io2')} />
										</div>
										<div className="flex items-center gap-x-0.5">
											<label>IO3</label>
											<Checkbox checked={checkboxState.io3} onCheckedChange={() => handleCheckboxChange('io3')} />
										</div>
										<div className="flex items-center gap-x-0.5">
											<label>发送控制字符串</label>
