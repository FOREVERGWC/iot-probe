...
import { columns, columns2, columns3, columns4, columns5 } from '@/app/(non-public)/device/[id]/modules/types'
						...
						<CardContent className="space-y-2">
							...
							<Row label="发送数据">
								<div className="relative w-full">
									...
									/>
									<button className="absolute right-0 top-0 bottom-0 px-4 py-2" onClick={handleBlur}>
										发送
									</button>
								</div>
							</Row>
								...
								<Row label="数字控制">
									<div className="flex gap-x-24">
										<div className="flex items-center gap-x-2">
											<label>IO1</label>
											<RadioGroup
												onValueChange={value => handleRadioChange('io1', value)}
												defaultValue={String(checkboxState.io1)}>
										...
										<div className="flex items-center gap-x-2">
											<label>IO2</label>
											<RadioGroup
												onValueChange={value => handleRadioChange('io2', value)}
												defaultValue={String(checkboxState.io2)}>
												<div className="flex items-center space-x-2">
													<RadioGroupItem value="false" id="io1_0" />
													<Label htmlFor="0">低电平0</Label>
												</div>
										...
										<div className="flex items-center gap-x-2">
											<label>IO3</label>
											<RadioGroup
												onValueChange={value => handleRadioChange('io3', value)}
												defaultValue={String(checkboxState.io3)}>
												<div className="flex items-center space-x-2">
													<RadioGroupItem value="false" id="io1_0" />
													<Label htmlFor="0">低电平0</Label>
												</div>
										...
										<div className="flex items-center gap-x-0.5">
											<label>发送控制字符串</label>
											<Checkbox checked={checkboxState.io4} onCheckedChange={() => handleCheckboxChange('io4')} />
										</div>
									</div>
								</Row>
							)}
