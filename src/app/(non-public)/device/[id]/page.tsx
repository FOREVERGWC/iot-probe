      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-10">
        ...
        <Card className="col-span-1 row-span-1">
          <CardHeader>
            ...
            <Row
                label="以太网状态">{data.lastChangeLog?.ethernet === -1 ? '正常' : (data.lastChangeLog?.ethernet ? '异常' : '未知')}</Row>
          </CardHeader>
        </Card>
        <Card className="col-span-1 row-span-1">
          <CardHeader>
        ...
        <Card className="col-span-1 row-span-1">
          <CardHeader>
            ...
            <Row label="接收数据">{base64Encoded(data.lastLog.serial_tx)}</Row>
            <Row label="发送数据">{base64Encoded(data.lastLog.serial_rx)}</Row>
          </CardHeader>
        </Card>
